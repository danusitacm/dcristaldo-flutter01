...
class AppColors {
  static const Color primaryDarkBlue = Color(0xFF10498A); 
  static const Color primaryLightBlue = Color(0xFF006CB5); 
  static const Color neutralGray = Color(0xFF898989); 

  static const Color primary = primaryDarkBlue;
  static const Color primaryHover = primaryLightBlue;
  static const Color primaryActive = neutralGray; 
